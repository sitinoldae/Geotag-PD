...
public class SignUpActivity extends AppCompatActivity implements Callback<MyUserData> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = (Spinner) findViewById(R.id.spinnerdpt);
        getData();
                ...
                new com.android.volley.Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            spinner.setAdapter(new ArrayAdapter<String>(SignUpActivity.this, android.R.layout.simple_spinner_dropdown_item, removedDuplicates));
